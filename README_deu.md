...
5. **Echte Test-Suite** - `python -m pytest tests/ -q` (81 Tests, die config, pipeline, MediaMTX-Generierung, die Puffer-/Wiederverbindungspolitik, die HailoRT-Integrationsgrenze und die CLI abdecken).
