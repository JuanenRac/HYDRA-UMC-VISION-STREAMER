...
5. **Suite de tests réelle** - `python -m pytest tests/ -q` (81 tests couvrant config, pipeline, génération MediaMTX, la politique de tampon/reconnexion, la frontière d'intégration HailoRT, et le CLI).
